...
class RandomizerSettings():
    ...
    def __init__(
        ...
        self.objective_randomizer = ui_settings.get(settingkey.OBJECTIVE_RANDOMIZER)
        self.objective_difficulty = ui_settings.get(settingkey.OBJECTIVE_DIFFICULTY)
        self.objectiveList = generateObjectives(self.enabledLocations, ui_settings.get(settingkey.AS_DATA_SPLIT), self.objective_difficulty)
        self.objectives_needed = ui_settings.get(settingkey.OBJECTIVES_NEEDED)
