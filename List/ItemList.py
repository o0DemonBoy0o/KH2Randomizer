...
class Items:
    ...
    def getItemList(story_unlocking_rarity = itemRarity.UNCOMMON):
        return [
            ...
            KH2Item(96, "High Jump",itemType.GROWTH_ABILITY, itemRarity.RARE),
            KH2Item(97, "High Jump",itemType.GROWTH_ABILITY, itemRarity.RARE),

            KH2Item(98, "Quick Run",itemType.GROWTH_ABILITY),
            KH2Item(99, "Quick Run",itemType.GROWTH_ABILITY, itemRarity.UNCOMMON),
            KH2Item(100, "Quick Run",itemType.GROWTH_ABILITY, itemRarity.RARE),
            KH2Item(101, "Quick Run",itemType.GROWTH_ABILITY, itemRarity.RARE),

            KH2Item(102, "Aerial Dodge",itemType.GROWTH_ABILITY),
            KH2Item(103, "Aerial Dodge",itemType.GROWTH_ABILITY, itemRarity.UNCOMMON),
            KH2Item(104, "Aerial Dodge",itemType.GROWTH_ABILITY, itemRarity.RARE),
            KH2Item(105, "Aerial Dodge",itemType.GROWTH_ABILITY, itemRarity.RARE),

            KH2Item(106, "Glide",itemType.GROWTH_ABILITY),
            KH2Item(107, "Glide",itemType.GROWTH_ABILITY, itemRarity.UNCOMMON),
            KH2Item(108, "Glide",itemType.GROWTH_ABILITY, itemRarity.RARE),
            KH2Item(109, "Glide",itemType.GROWTH_ABILITY, itemRarity.RARE),

            KH2Item(564, "Dodge Roll",itemType.GROWTH_ABILITY),
            KH2Item(565, "Dodge Roll",itemType.GROWTH_ABILITY, itemRarity.UNCOMMON),
            ...
            KH2Item(155, "Nobody Lance", itemType.STAFF, itemRarity.UNCOMMON), #StatEntry = 94
            KH2Item(549, "Precious Mushroom", itemType.STAFF, itemRarity.UNCOMMON), #StatEntry = 154
            KH2Item(550, "Precious Mushroom+", itemType.STAFF, itemRarity.UNCOMMON), #StatEntry = 155
            KH2Item(551, "Premium Mushroom", itemType.STAFF, itemRarity.UNCOMMON), #StatEntry = 156
            KH2Item(154, "Rising Dragon", itemType.STAFF, itemRarity.UNCOMMON), #StatEntry = 93
            KH2Item(503, "Save The Queen+", itemType.STAFF, itemRarity.UNCOMMON), #StatEntry = 146
            KH2Item(156, "Shaman's Relic", itemType.STAFF, itemRarity.UNCOMMON), #StatEntry = 95

            KH2Item(146, "Akashic Record", itemType.SHIELD, itemRarity.UNCOMMON), #StatEntry = 107
            KH2Item(553, "Frozen Pride+", itemType.SHIELD, itemRarity.UNCOMMON), #StatEntry = 158
            KH2Item(145, "Genji Shield", itemType.SHIELD, itemRarity.UNCOMMON), #StatEntry = 106
            KH2Item(556, "Majestic Mushroom", itemType.SHIELD, itemRarity.UNCOMMON), #StatEntry = 161
            KH2Item(557, "Majestic Mushroom+", itemType.SHIELD, itemRarity.UNCOMMON), #StatEntry = 162
            KH2Item(147, "Nobody Guard", itemType.SHIELD, itemRarity.UNCOMMON), #StatEntry = 108
            KH2Item(141, "Ogre Shield", itemType.SHIELD, itemRarity.UNCOMMON), #StatEntry = 102
            KH2Item(504, "Save The King+", itemType.SHIELD, itemRarity.UNCOMMON), #StatEntry = 147
            KH2Item(558, "Ultimate Mushroom", itemType.SHIELD, itemRarity.UNCOMMON), #StatEntry = 163
            ...
            KH2Item(46, "Fencer Earring", itemType.ACCESSORY, itemRarity.UNCOMMON),
            KH2Item(47, "Mage Earring", itemType.ACCESSORY),
            KH2Item(48, "Slayer Earring", itemType.ACCESSORY, itemRarity.UNCOMMON),
            KH2Item(53, "Medal", itemType.ACCESSORY),
            KH2Item(35, "Moon Amulet", itemType.ACCESSORY, itemRarity.RARE),
            KH2Item(36, "Star Charm", itemType.ACCESSORY, itemRarity.RARE),
            KH2Item(56, "Cosmic Arts", itemType.ACCESSORY, itemRarity.RARE),
            KH2Item(57, "Shadow Archive", itemType.ACCESSORY, itemRarity.UNCOMMON),
            KH2Item(58, "Shadow Archive+", itemType.ACCESSORY, itemRarity.RARE),
            KH2Item(64, "Full Bloom", itemType.ACCESSORY, itemRarity.UNCOMMON),
            KH2Item(66, "Full Bloom+", itemType.ACCESSORY, itemRarity.RARE),
            KH2Item(65, "Draw Ring", itemType.ACCESSORY, itemRarity.UNCOMMON),
            ...
            KH2Item(133, "Shock Charm+", itemType.ARMOR, itemRarity.UNCOMMON),
            ...
            KH2Item(306, "Petite Ribbon", itemType.ARMOR, itemRarity.RARE),
            KH2Item(304, "Ribbon", itemType.ARMOR, itemRarity.RARE),
            KH2Item(157, "Grand Ribbon", itemType.ARMOR, itemRarity.RARE),
    ...
    def getStatItems():
        ...
        return list(itertools.repeat(KH2Item(470, "Max HP Up", itemType.GAUGE),20)) + \
            ...
            list(itertools.repeat(KH2Item(472, "Drive Gauge Up", itemType.GAUGE, itemRarity.RARE),6)) + \
            list(itertools.repeat(KH2Item(473, "Armor Slot Up", itemType.SLOT, itemRarity.UNCOMMON),3)) + \
            list(itertools.repeat(KH2Item(474, "Accessory Slot Up", itemType.SLOT, itemRarity.UNCOMMON),3)) + \
            list(itertools.repeat(KH2Item(463, "Item Slot Up", itemType.SLOT, itemRarity.UNCOMMON),5))
    ...
    def getSupportAbilityList():
        return [
            ...
            KH2Item(539,"Combo Master",itemType.SUPPORT_ABILITY,itemRarity.RARE),
            ...
            KH2Item(405,"Draw",itemType.SUPPORT_ABILITY,itemRarity.UNCOMMON),
            KH2Item(405,"Draw",itemType.SUPPORT_ABILITY,itemRarity.UNCOMMON),
            KH2Item(405,"Draw",itemType.SUPPORT_ABILITY,itemRarity.UNCOMMON),
            ...
            KH2Item(411,"Item Boost",itemType.SUPPORT_ABILITY,itemRarity.UNCOMMON),
            ...
            KH2Item(404,"No Experience",itemType.SUPPORT_ABILITY),
            KH2Item(541,"Light & Darkness",itemType.SUPPORT_ABILITY,itemRarity.RARE),
        ]
    ...
    def getActionAbilityList():
        return [
            ...
            KH2Item(265, "Guard Break", itemType.ACTION_ABILITY,itemRarity.RARE),
            KH2Item(266, "Explosion", itemType.ACTION_ABILITY,itemRarity.RARE),
            KH2Item(269, "Aerial Sweep", itemType.ACTION_ABILITY,itemRarity.UNCOMMON),
            KH2Item(560, "Aerial Dive", itemType.ACTION_ABILITY,itemRarity.RARE),
            KH2Item(270, "Aerial Spiral", itemType.ACTION_ABILITY,itemRarity.RARE),
            KH2Item(272, "Aerial Finish", itemType.ACTION_ABILITY),
            KH2Item(561, "Magnet Burst", itemType.ACTION_ABILITY,itemRarity.RARE),
    ...
    def getJunkList(betterJunk):
        if betterJunk:
            return [
                ...
                KH2Item(4, "Elixir", itemType.ITEM,itemRarity.UNCOMMON),
                KH2Item(5, "Mega-Potion", itemType.ITEM),
                KH2Item(6, "Mega-Ether", itemType.ITEM),
                KH2Item(7, "Megalixir", itemType.ITEM,itemRarity.UNCOMMON),
                KH2Item(131, "Tent", itemType.ITEM),
                KH2Item(274, "Drive Recovery", itemType.ITEM,itemRarity.UNCOMMON),
                KH2Item(275, "High Drive Recovery", itemType.ITEM,itemRarity.UNCOMMON),
    ...
    def getDonaldAbilityList():
        return [
            ...
            KH2Item(199, "Fantasia (Comet)", itemType.DONALD_ABILITY),
            KH2Item(200, "Flare Force (Duckflare)", itemType.DONALD_ABILITY),
    ...
    def getGoofyAbilityList():
        return [
            ...
            KH2Item(201, "Tornado Fusion (Whirligoof)", itemType.GOOFY_ABILITY),
            KH2Item(202, "Teamwork (Knocksmash)", itemType.GOOFY_ABILITY),
